...
async function main() {
  ...
  const productsData = [
    ...
    // Luxury Skincare
    {
      ...
      description: "High-performance serum that reduces signs of aging, hydrates and improves skin radiance.",
      price: 119900,
      ...
      isFeatured: true,
      status: ProductStatus.IN_STOCK,
      tags: ["Skincare", "Serum", "Estée Lauder", "Advanced Night Repair"],
      variants: {
        create: [
