...
const DEFAULT_CONTACT_SETTINGS: UpdateContactSettingsDTO = {
...
export class ContactService {
  /* ================= Contact Settings ================= */
  static async getContactSettings(activeOnly = false): Promise<ContactSettingsItem> {
    ...
    return settings as ContactSettingsItem;
  }

  static async updateContactSettings(data: UpdateContactSettingsDTO): Promise<ContactSettingsItem> {
    ...
    return updated as ContactSettingsItem;
  }

  /* ================= Contact Messages ================= */
  static async createContactMessage(data: CreateContactMessageDTO): Promise<ContactMessageItem> {
    ...
    return created as ContactMessageItem;
  }

  static async getAllContactMessages(status?: string, search?: string): Promise<ContactMessageItem[]> {
    const where: any = {};
    ...
    return messages as ContactMessageItem[];
  }

  static async getContactMessageById(id: string): Promise<ContactMessageItem> {
    ...
    return message as ContactMessageItem;
  }
  ...
  static async updateContactMessageStatus(
    ...
    return updated as ContactMessageItem;
  }
