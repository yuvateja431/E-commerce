import { PrismaClient, CouponStatus } from "@prisma/client";
...
export class CouponService {
  ...
  static async createCoupon(data: any, createdBy?: string) {
  ...
  static async getAllCoupons(query: any) {
    const { 
      page = 1, limit = 10, search, status, type, sortBy = 'createdAt', sortOrder = 'desc' 
    } = query;
