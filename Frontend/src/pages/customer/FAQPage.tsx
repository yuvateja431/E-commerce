      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3.5 text-sm bg-white border border-slate-200 rounded-2xl shadow-xs focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition text-slate-800 placeholder-slate-400"
          />
        </div>
          ...
          <div className="space-y-4">
            {filteredFaqs.map((faq, index) => {
              ...
              return (
                <div
                  key={faq.id}
                  className="bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-2xs transition hover:border-slate-300"
                >
                  <button
