      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <Link
            ...
            className="px-4 py-2 bg-[#4f39f6] hover:bg-[#4330d8] text-white text-xs sm:text-sm font-bold rounded-xl shadow-md transition flex items-center gap-2 cursor-pointer shrink-0"
          >
                    ...
                    >
                      ...
                      <td className="px-6 py-4.5">
                        <button
                          ...
                          className={`rounded-full px-3.5 py-1.5 text-xs font-bold inline-flex items-center gap-1.5 border transition cursor-pointer ${
                      ...
                      <td className="px-6 py-4.5 text-right pr-8">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Link
                            ...
                            className="w-9 h-9 rounded-xl bg-white border border-purple-100 shadow-2xs hover:bg-purple-50 text-[#4f39f6] transition flex items-center justify-center cursor-pointer inline-flex"
                            title="Edit Coupon"
                          >
                            <FiEdit2 size={15} />
                          </Link>
                          ...
                          <button
                            ...
                            className="w-9 h-9 rounded-xl bg-white border border-rose-100 shadow-2xs hover:bg-rose-50 text-rose-500 transition flex items-center justify-center cursor-pointer inline-flex"
                            title="Delete Coupon"
                          >
                            <FiTrash2 size={15} />
                          </button>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 sm:p-7 border border-slate-100 animate-in zoom-in-95 duration-150">
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <button
                type="button"
                onClick={() => setCouponToDelete(null)}
                className="px-6 py-2.5 bg-slate-100 hover:bg-slate-200/80 text-slate-700 text-sm font-bold rounded-2xl transition cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white text-sm font-bold rounded-2xl shadow-sm transition cursor-pointer"
              >
                Delete
              </button>
            </div>
