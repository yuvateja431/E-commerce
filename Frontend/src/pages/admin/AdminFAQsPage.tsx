...
import type { FAQ, CreateFAQRequest, UpdateFAQRequest } from "../../types/cms";
import {
  FiPlus,
  FiSearch,
  FiEdit,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold transition flex items-center gap-2 shadow-sm shadow-blue-500/20"
        >
          <FiPlus size={16} />
                  ...
                  <tr key={faq.id} className="hover:bg-slate-50/60 transition">
                    ...
                    <td className="py-4 px-6">
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-extrabold transition cursor-pointer ${
                          faq.status === "Active"
            ...
            <form onSubmit={handleSaveFaq} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3.5 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-semibold text-slate-900"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="w-full px-3.5 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-medium text-slate-800 resize-y"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-bold text-slate-900"
                  />
                </div>
              ...
              <div className="pt-4 flex items-center justify-end gap-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl transition flex items-center gap-2 disabled:opacity-50"
                >
