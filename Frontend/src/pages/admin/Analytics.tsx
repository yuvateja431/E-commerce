...
import { 
  FiChevronDown, FiTrendingUp, FiUsers, FiClock, FiActivity, 
  FiArrowUpRight, FiArrowDownRight, FiMapPin, FiGlobe
} from "react-icons/fi";
              ...
              <div key={idx} className="space-y-2">
                ...
                <div className="w-full h-2.5 bg-gray-50 border border-gray-100 rounded-full overflow-hidden">
                  <div 
                    ...
                    style={{ width: `${stage.percentage}%`, backgroundColor: stage.fill }}
                  />
                </div>
              </div>
            ))}
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] p-6 space-y-6">
          ...
          <div className="divide-y divide-gray-50">
            {trafficSources.map((item, idx) => (
              <div key={idx} className="flex items-center justify-between py-3 gap-4 group">
