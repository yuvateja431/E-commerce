...
export const addItem = createAsyncThunk("cart/addItem", async (data: { productId: string; variantId?: string | null; quantity: number }) => {
  const res = await api.post("/cart/add", data);
  return res.data.data;
});

export const updateItem = createAsyncThunk("cart/updateItem", async (data: { productId: string; quantity: number }) => {
