...
export const RecentTransactions = () => {
    ...
    return (<div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md rounded-2xl shadow-lg p-4">
      ...
      <table className="w-full table-auto text-sm">
        ...
        <tbody>
          {orders.map((o) => (<tr key={o.id} className="border-b border-gray-100 dark:border-gray-600">
