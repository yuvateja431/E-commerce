        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 h-[76px] flex items-center justify-between gap-4 sm:gap-6">
          ...
          <div className="flex-1 max-w-[500px] mx-4 hidden md:block relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-5 py-3 text-[13px] font-medium text-slate-700 bg-[#F5F5FF] border border-transparent rounded-full focus:outline-none focus:bg-white focus:ring-2 focus:ring-[#6366F1]/20 focus:border-[#6366F1]/40 transition placeholder-slate-400"
            />
          </div>
          ...
          <div className="flex items-center gap-8 shrink-0">
            ...
            <div className="flex items-center gap-5">
              ...
              <Link to="/wishlist" className="text-[#475569] hover:text-[#6366F1] transition relative">
                ...
                {wishlistCount > 0 && (
                  <span className="absolute -top-1.5 -right-2 bg-rose-500 text-white text-[10px] font-black h-4 w-4 rounded-full flex items-center justify-center">
                    {wishlistCount}
                  </span>
                )}
              </Link>
              ...
              <Link to="/cart" className="text-[#475569] hover:text-[#6366F1] transition relative">
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-1.5 -right-2 bg-[#6366F1] text-white text-[10px] font-black h-4 w-4 rounded-full flex items-center justify-center">
                    {cartCount}
                  </span>
                )}
              </Link>
              ...
              {user ? (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2.5 p-1 pr-2 rounded-full hover:bg-slate-50 transition"
                  >
                    ...
                    {isMenuOpen && (
                      <>
                        ...
                        <motion.div
                          ...
                          className="absolute right-0 mt-3 w-60 bg-white rounded-2xl shadow-xl border border-slate-100 z-50 overflow-hidden"
                        >
                          ...
                          <div className="p-2 space-y-1">
                            ...
                            <button
                              ...
                              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-rose-500 hover:bg-rose-50 transition text-sm font-semibold"
                            >
                              <FiLogOut size={16} />
                              <span>Logout</span>
                            </button>
                ...
                <Link
                  to="/login"
                  className="px-5 py-2.5 bg-[#6366F1] hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition shadow-sm"
                >
                  Login
                </Link>
              )}
          ...
          <div>
            ...
            <div className="flex rounded-xl overflow-hidden border border-slate-700 focus-within:border-indigo-500 transition shadow-inner">
              <input
                ...
                className="bg-[#1E293B] border-none px-4 py-3 w-full text-[13px] text-white focus:ring-0 focus:outline-none placeholder-slate-500"
              />
